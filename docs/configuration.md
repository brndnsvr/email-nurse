...
1. **Create the LaunchAgent plist** at `~/Library/LaunchAgents/com.email-nurse-report.plist`:
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-report</string>
...
# Load LaunchAgent
launchctl load ~/Library/LaunchAgents/com.email-nurse-report.plist
...
launchctl start com.email-nurse-report
