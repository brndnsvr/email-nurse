...
|-------------|---------------|---------------------|
| autopilot.yaml | `HOME_DIR/code/email-nurse/deploy/config/autopilot.yaml` | `~/.config/email-nurse/autopilot.yaml` |
| rules.yaml | `HOME_DIR/code/email-nurse/deploy/config/rules.yaml` | `~/.config/email-nurse/rules.yaml` |
| templates.yaml | `HOME_DIR/code/email-nurse/deploy/config/templates.yaml` | `~/.config/email-nurse/templates.yaml` |

### Sync Policy: Merge First

Before editing configs, always check for differences between repo and production:
```bash
diff HOME_DIR/code/email-nurse/deploy/config/<file> ~/.config/email-nurse/<file>
```
...
```bash
cp HOME_DIR/code/email-nurse/deploy/config/<file> ~/.config/email-nurse/<file>
```
