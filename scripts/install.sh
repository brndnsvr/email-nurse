...
PLIST_NAME="com.email-nurse.plist"
...
PLIST_PATH="$HOME/Library/LaunchAgents/com.email-nurse.plist"
...
WATCHER_PLIST_NAME="com.email-nurse-watcher.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-watcher</string>
...
DIGEST_PLIST_NAME="com.email-nurse-digest.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-digest</string>
...
OPS_STUCK_PLIST="com.email-nurse-ops-stuck.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-ops-stuck</string>
    <key>ProgramArguments</key>
    <array>
...
OPS_HEALTH_PLIST="com.email-nurse-ops-health.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-ops-health</string>
    <key>ProgramArguments</key>
    <array>
...
OPS_DB_PLIST="com.email-nurse-ops-db.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-ops-db</string>
    <key>ProgramArguments</key>
    <array>
...
BREW_SYSM_PLIST="com.email-nurse-brew-sysm.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-brew-sysm</string>
    <key>ProgramArguments</key>
    <array>
...
BREW_ALL_PLIST="com.email-nurse-brew-all.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-brew-all</string>
    <key>ProgramArguments</key>
    <array>
...
BREW_CLEANUP_PLIST="com.email-nurse-brew-cleanup.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-brew-cleanup</string>
    <key>ProgramArguments</key>
    <array>
...
LOG_ROTATE_PLIST="com.email-nurse-log-rotate.plist"
...
<dict>
    <key>Label</key>
    <string>com.email-nurse-log-rotate</string>
    <key>ProgramArguments</key>
    <array>
...
echo "    Test now: ${CYAN}launchctl start com.email-nurse-digest${NC}"
echo ""
